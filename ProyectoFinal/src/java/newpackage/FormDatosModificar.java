 ...
 * @author kvenegas3
 */
@WebServlet(name = "FormDatosModificar", urlPatterns = {"/FormDatosModificar"})
public class FormDatosModificar extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           ResultSet rs =base.consultaSQL( "select * from pedidos where idpedidos like '" +ID+ "'");
            ...
            while(rs.next()){*/
                ...
                response.sendRedirect("FormDatosModificar.jsp");
               return;
            }
