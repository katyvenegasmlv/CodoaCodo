...
<html>
    <head>
        ...
        <title>Nutricion y Bienestar</title>
    </head>
    <body>
       <div>
            <div id="header">
  ...
  <div class="col">
    <div class="card">
      <img src="imagenes/licuadora.PNG" class="card-img-top" id="tam-im" alt="...">
      <div class="card-body">
        <h5 class="card-title">Licuadora multifunción</h5>
  ...
  <div class="col">
    <div class="card">
      <img src="imagenes/vaso.PNG" class="card-img-top" id="tam-im" alt="...">
      <div class="card-body">
        <h5 class="card-title">Vaso Shaker</h5>
        <input class="btn btn-primary" type="submit" value="Comprar">
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      <img src="imagenes/band.PNG" class="card-img-top" id="tam-im" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="imagenes/balanza.PNG" class="card-img-top" id="tam-im" alt="...">
      <div class="card-body">
